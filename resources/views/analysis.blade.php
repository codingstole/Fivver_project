<!DOCTYPE html><!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="en-US"> <![endif]--><!--[if IE 7]>         <html class="no-js lt-ie9 lt-ie8" lang="en-US"> <![endif]--><!--[if IE 8]>         <html class="no-js lt-ie9" lang="en-US"> <![endif]--><!--[if gt IE 8]><!--><html class="no-js" lang="en-US"><!--<![endif]--><head>
  ...
  <title>Analysis – Exchange Alternative – Cryptocurrency</title>
  ...
  */
  ...
  <!--analysisi starts from here-->
<!-- TradingView Widget BEGIN -->
<section>
<div style="text-align:center;">
    <h2 style="margin:20px;border-bottom:2px solid black;">Analysis of BTC/USD<SS/h2>
</div>
  ...
  <!--analysisi ends from here-->
  <section>
    <div style="text-align:center;">
        <h2 style="margin:20px;border-bottom:2px solid black;">Analysis of Matic/USD<SS/h2>
    </div>
<!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
    <div class="tradingview-widget-container__widget"></div>
...
<!-- TradingView Widget BEGIN -->
  ...
  <section>
    <div style="text-align:center;">
        <h2 style="margin:20px;border-bottom:2px solid black;">Analysis of ETC/USD<SS/h2>
    </div>
...
<div class="tradingview-widget-container">
  ...
  <section>
    <div style="text-align:center;">
        <h2 style="margin:20px;border-bottom:2px solid black;">Analysis of BNB/USD<SS/h2>
    </div>
<div class="tradingview-widget-container">
    <div class="tradingview-widget-container__widget"></div>
    <script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-advanced-chart.js" async>
  ...
  <section>
    <div style="text-align:center;">
        <h2 style="margin:20px;border-bottom:2px solid black;">Analysis of SOL/USD<SS/h2>
    </div>
...
<section>
    <div style="text-align:center;">
        <h2 style="margin:20px;border-bottom:2px solid black;">Analysis of DOGE/USD<SS/h2>
    </div>
